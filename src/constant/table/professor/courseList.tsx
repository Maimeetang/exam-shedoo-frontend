...
export const getColumns = (): TableProps<TeachingCourse>["columns"] => [
  {
    title: "No.",
    key: "no",
    render: (_, __, index) => index + 1,
  },
  { title: "CourseID", dataIndex: "course_code", key: "course_code" },
  { title: "Course Name", dataIndex: "course_name", key: "course_name" },
  { title: "Lec Section", dataIndex: "lec_section", key: "lec_section" },
  { title: "Lab Section", dataIndex: "lab_section", key: "lab_section" },
  {
    title: "Midterm Exam",
    children: [
      {
